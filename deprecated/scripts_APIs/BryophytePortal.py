"""
BryophytePortal.py — BryophytePortal (Symbiota) API client

Queries the BryophytePortal portal to retrieve species-level synonym names
for a given bryophyte species name.
...
Main entry point: get_bryophyteportal_synonyms(query)
"""
...
BASE_URL = "https://bryophyteportal.org/portal"
...
def main():
    ...
    result = get_bryophyteportal_synonyms("Marchantia polymorpha")
...
def get_bryophyteportal_synonyms(species_name: str) -> dict:
    """
    Given a species name, returns a dict of species-level synonym names from BryophytePortal.
    ...
    Returns an empty dict if the species is not found in BryophytePortal.

    Example:
        {"Marchantia polymorpha": [], "Jungermannia polymorpha": [], "Marchantia alpestris": []}
    """
